...
async def test_suite():
    ...
    print(f"  [OK] Location Required OK: Answer='{res_no_loc.answer[:60]}...'")
    ...
    print(f"  [OK] Forecast OK: {forecast.location.name} Temp={forecast.current.temperature}°C Condition={forecast.current.condition}")
    ...
    print(f"  [OK] Override OK: Answered for {res_override.location.name} | explicit_override={res_override.explicit_override}")
    ...
    print("\n[PASSED] ALL ACCEPTANCE TEST SUITES PASSED SUCCESSFULLY!")
